...
import 'pacientes_screen.dart'; // Importar la pantalla de pacientes
          ...
          Center(
            child: Column(
              ...
              children: [
                ...
                // Botón para ver la lista de médicos
                ElevatedButton(
                  style: ElevatedButton.styleFrom(
                    padding: EdgeInsets.symmetric(horizontal: 40, vertical: 15),
                    textStyle: TextStyle(fontSize: 18),
                  ...
                  child: Text('Ver Lista de Médicos y Especialidades'),
                ),
                SizedBox(height: 20), // Espaciado entre los botones
                // Nuevo botón para listar pacientes
                ElevatedButton(
                  style: ElevatedButton.styleFrom(
                    padding: EdgeInsets.symmetric(horizontal: 40, vertical: 15),
                    textStyle: TextStyle(fontSize: 18),
                  ...
                  child: Text('Agregar y Listar Pacientes'),
                ),
              ],
            ),
          ),
